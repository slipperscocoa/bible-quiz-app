...
class CWC2S2App extends React.Component {
    render() {
        return (
            <div>
            <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/the-escape-to-egypt">Click for Crossword!</a>
