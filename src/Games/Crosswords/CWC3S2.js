...
class CWC3S2App extends React.Component {
    render() {
        return (
            <div>
            <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/the-baptism-of-jesus-4">Click for Crossword!</a>
