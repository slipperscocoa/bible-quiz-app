...
class CWC5S3App extends React.Component {
    render() {
        return (
            <div>
                <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/salt-and-light-2">Click for Crossword!</a>
