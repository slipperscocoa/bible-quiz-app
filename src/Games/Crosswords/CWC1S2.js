...
class CWC1S2App extends React.Component {
    render() {
        return (
            <div>
            <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/joseph-accepts-jesus-as-his-son">Click for Crossword!</a>
