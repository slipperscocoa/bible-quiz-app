...
class CWC5S9App extends React.Component {
    render() {
        return (
            <div>
                <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/eye-for-eye">Click for Crossword!</a>
