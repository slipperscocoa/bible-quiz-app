...
class CWC4S4App extends React.Component {
    render() {
        return (
            <div>
                <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/jesus-heals-the-sick">Click for Crossword!</a>
