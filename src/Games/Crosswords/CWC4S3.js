...
class CWC4S3App extends React.Component {
    render() {
        return (
            <div>
                <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/jesus-calls-his-first-disciples">Click for Crossword!</a>
