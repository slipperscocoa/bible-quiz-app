...
class CWC3S1App extends React.Component {
    render() {
        return (
            <div>
            <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/john-the-baptist-prepares-the-way">Click for Crossword!</a>
