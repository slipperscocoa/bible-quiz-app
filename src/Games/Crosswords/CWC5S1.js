...
class CWC5S1App extends React.Component {
    render() {
        return (
            <div>
                <a style={{ fontSize: '36px' }} href="https://crosswordlabs.com/embed/introduction-to-the-sermon-on-the-mount">Click for Crossword!</a>
