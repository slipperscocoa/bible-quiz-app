        ...
        return(
            <div>
                ...
                <ul style={{ listStyleType: 'none', fontSize: '20px' }}>
                    <li style={{ paddingBottom: '15px', textAlign: 'left' }}><a style={{ color: 'white'}}><Link to="/qc1s1">Chapter 1: The Genealogy of Jesus the Messiah</Link></a></li>
                    <li style={{ paddingBottom: '15px', textAlign: 'left' }}><a style={{ color: 'white'}}><Link to="/qc1s2">Chapter 1: Joseph Accepts Jesus as His Son</Link></a></li>
                    <li style={{ paddingBottom: '15px', textAlign: 'left' }}><a style={{ color: 'white'}}><Link to="/qc2s1">Chapter 2: The Magi Visit the Messiah</Link></a></li>
                    <li style={{ paddingBottom: '15px', textAlign: 'left' }}><a style={{ color: 'white'}}><Link to="/qc2s2">Chapter 2: The Escape to Egypt</Link></a></li>
                    <li style={{ paddingBottom: '15px', textAlign: 'left' }}><a style={{ color: 'white'}}><Link to="/qc2s3">Chapter 2: The Return to Nazareth</Link></a></li>
